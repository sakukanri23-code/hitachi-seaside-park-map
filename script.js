...
const zones = [
    { name: "みはらしエリア", pos: [36.4052940, 140.6003324], color: "#3498db" },
    { name: "プレジャーガーデン", pos: [36.392, 140.603], color: "#e67e22" },
    { name: "砂丘エリア", pos: [36.3982060, 140.6094563], color: "#27ae60" },
    { name: "草原エリア", pos: [36.4013528, 140.6011840], color: "#f1c40f" },
    { name: "樹林エリア", pos:[(36.4076046, 140.5960791], color: "#ff0000" }
];
